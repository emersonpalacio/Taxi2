...
namespace Taxi.Web.Migrations
{
    ...
    [Migration("20200519133755_finalliInitilaDb")]
    partial class finalliInitilaDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taxi.Web.Data.Entities.TaxiEntities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Taxi.Web.Data.Entities.TripEntity", b =>
                {
                    ...
                    b.Property<double>("TargetLogitude");
            ...
            modelBuilder.Entity("Taxi.Web.Data.Entities.TripEntity", b =>
                {
                    b.HasOne("Taxi.Web.Data.Entities.TaxiEntities", "Taxi")
                        .WithMany("Trip")
